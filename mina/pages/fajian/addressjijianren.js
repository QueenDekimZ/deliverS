// pages/fajian/addressjijianren.js
//获取应用实例
...
Page({
    ...
    bindSave: function (e) {
        app.console(this.data.selProvince + this.data.selCity + this.data.selDistrict);
        ...
        app.globalData.fromaddress = addfont + this.data.fromaddress;
        app.globalData.fromname = this.data.fromname;
        app.globalData.frommobile = this.data.frommobile;
        wx.navigateBack({});
    },
    ...
    getFromMobile: function (e) {
        this.setData({
            frommobile: e.detail.value
        })
    },
    getFromAddress: function (e) {
        this.setData({
